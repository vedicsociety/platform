...
// There is also a set of methods that allow a default value to be supplied.
// The configuration data will allow nested configuration sections, which can be obtained using the GetSection method.
package config
